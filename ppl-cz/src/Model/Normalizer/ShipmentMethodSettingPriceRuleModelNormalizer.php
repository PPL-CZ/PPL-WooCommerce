...
class ShipmentMethodSettingPriceRuleModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PPLCZ\\Model\\Model\\ShipmentMethodSettingPriceRuleModel';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'PPLCZ\\Model\\Model\\ShipmentMethodSettingPriceRuleModel';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \PPLCZ\Model\Model\ShipmentMethodSettingPriceRuleModel();
    ...
    {
        return array('PPLCZ\\Model\\Model\\ShipmentMethodSettingPriceRuleModel' => false);
    }
}