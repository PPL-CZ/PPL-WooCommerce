...
class CartDataModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PPLCZ\\Model\\Model\\CartDataModel';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'PPLCZ\\Model\\Model\\CartDataModel';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \PPLCZ\Model\Model\CartDataModel();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('parcelData', $data)) {
            $object->setParcelData($this->denormalizer->denormalize($data['parcelData'], 'PPLCZ\\Model\\Model\\ParcelDataModel', 'json', $context));
            unset($data['parcelData']);
        }
        if (\array_key_exists('additionalData', $data)) {
            $object->setAdditionalData($this->denormalizer->denormalize($data['additionalData'], 'PPLCZ\\Model\\Model\\AdditionalDataModel', 'json', $context));
    ...
    {
        $data = array();
        if ($object->isInitialized('parcelData') && null !== $object->getParcelData()) {
            $data['parcelData'] = $this->normalizer->normalize($object->getParcelData(), 'json', $context);
        }
