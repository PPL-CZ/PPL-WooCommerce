...
class PrintSettingModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PPLCZ\\Model\\Model\\PrintSettingModel';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'PPLCZ\\Model\\Model\\PrintSettingModel';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \PPLCZ\Model\Model\PrintSettingModel();
        ...
        if (\array_key_exists('orderStatuses', $data)) {
            $values = array();
            foreach ($data['orderStatuses'] as $value) {
                $values[] = $value;
            }
            $object->setOrderStatuses($values);
            unset($data['orderStatuses']);
        }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('orderStatuses') && null !== $object->getOrderStatuses()) {
            $values = array();
            foreach ($object->getOrderStatuses() as $value) {
                $values[] = $value;
            }
            $data['orderStatuses'] = $values;
        }
    ...
    {
        return array('PPLCZ\\Model\\Model\\PrintSettingModel' => false);
    }
}