...
class CalculatedDPHNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PPLCZ\\Model\\Model\\CalculatedDPH';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'PPLCZ\\Model\\Model\\CalculatedDPH';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \PPLCZ\Model\Model\CalculatedDPH();
        ...
        if (\array_key_exists('dphId', $data)) {
            $object->setDphId($data['dphId']);
            unset($data['dphId']);
        }
    ...
    {
        $data = array();
        if ($object->isInitialized('dphId') && null !== $object->getDphId()) {
            $data['dphId'] = $object->getDphId();
        }
    ...
    {
        return array('PPLCZ\\Model\\Model\\CalculatedDPH' => false);
    }
}