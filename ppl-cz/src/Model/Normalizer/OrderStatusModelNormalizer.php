...
class OrderStatusModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PPLCZ\\Model\\Model\\OrderStatusModel';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'PPLCZ\\Model\\Model\\OrderStatusModel';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \PPLCZ\Model\Model\OrderStatusModel();
    ...
    {
        return array('PPLCZ\\Model\\Model\\OrderStatusModel' => false);
    }
}