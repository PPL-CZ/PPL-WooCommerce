...
class ErrorLogCategorySettingModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PPLCZ\\Model\\Model\\ErrorLogCategorySettingModel';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'PPLCZ\\Model\\Model\\ErrorLogCategorySettingModel';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \PPLCZ\Model\Model\ErrorLogCategorySettingModel();
        ...
        if (\array_key_exists('setting', $data)) {
            $object->setSetting($this->denormalizer->denormalize($data['setting'], 'PPLCZ\\Model\\Model\\CategoryModel', 'json', $context));
            unset($data['setting']);
        }
    ...
    {
        return array('PPLCZ\\Model\\Model\\ErrorLogCategorySettingModel' => false);
    }
}