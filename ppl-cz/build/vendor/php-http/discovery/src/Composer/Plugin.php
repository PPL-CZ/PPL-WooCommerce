...
namespace PPLCZVendor\Http\Discovery\Composer;

use PPLCZVendor\Composer\Composer;
use PPLCZVendor\Composer\DependencyResolver\Pool;
use PPLCZVendor\Composer\EventDispatcher\EventSubscriberInterface;
use PPLCZVendor\Composer\Factory;
use PPLCZVendor\Composer\Installer;
use PPLCZVendor\Composer\IO\IOInterface;
use PPLCZVendor\Composer\Json\JsonFile;
use PPLCZVendor\Composer\Json\JsonManipulator;
use PPLCZVendor\Composer\Package\Locker;
use PPLCZVendor\Composer\Package\Version\VersionParser;
use PPLCZVendor\Composer\Package\Version\VersionSelector;
use PPLCZVendor\Composer\Plugin\PluginInterface;
use PPLCZVendor\Composer\Repository\InstalledRepositoryInterface;
use PPLCZVendor\Composer\Repository\RepositorySet;
use PPLCZVendor\Composer\Script\Event;
use PPLCZVendor\Composer\Script\ScriptEvents;
use PPLCZVendor\Composer\Util\Filesystem;
...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    private const INTERFACE_MAP = ['php-http/async-client-implementation' => ['PPLCZVendor\\Http\\Client\\HttpAsyncClient'], 'php-http/client-implementation' => ['PPLCZVendor\\Http\\Client\\HttpClient'], 'psr/http-client-implementation' => ['PPLCZVendor\\Psr\\Http\\Client\\ClientInterface'], 'psr/http-factory-implementation' => ['PPLCZVendor\\Psr\\Http\\Message\\RequestFactoryInterface', 'PPLCZVendor\\Psr\\Http\\Message\\ResponseFactoryInterface', 'PPLCZVendor\\Psr\\Http\\Message\\ServerRequestFactoryInterface', 'PPLCZVendor\\Psr\\Http\\Message\\StreamFactoryInterface', 'PPLCZVendor\\Psr\\Http\\Message\\UploadedFileFactoryInterface', 'PPLCZVendor\\Psr\\Http\\Message\\UriFactoryInterface']];
    ...
    public function getMissingRequires(InstalledRepositoryInterface $repo, array $requires, bool $isProject, array $pinnedAbstractions) : array
    {
        ...
        if (ClassDiscovery::safeClassExists(\PPLCZVendor\Phalcon\Http\Message\RequestFactory::class, \false)) {
