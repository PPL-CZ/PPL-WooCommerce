...
use PPLCZVendor\Latte;
use PPLCZVendor\Nette;
use PPLCZVendor\Tracy;
use PPLCZVendor\Tracy\BlueScreen;
use PPLCZVendor\Tracy\Helpers;
/**
...
class Bridge
{
    ...
    {
        if ($e instanceof Latte\CompileException && @\is_file($e->sourceName) && (\preg_match('#Unknown macro (\\{\\w+)\\}, did you mean (\\{\\w+)\\}\\?#A', $e->getMessage(), $m) || \preg_match('#Unknown attribute (n:\\w+), did you mean (n:\\w+)\\?#A', $e->getMessage(), $m))) {
