...
namespace PPLCZVendor\Tracy\Bridges\Nette;

use PPLCZVendor\Nette;
use PPLCZVendor\Nette\Schema\Expect;
use PPLCZVendor\Tracy;
/**
    ...
    public function afterCompile(Nette\PhpGenerator\ClassType $class)
    {
        ...
        foreach ($options as $key => $value) {
            if ($value !== null) {
                ...
                $initialize->addBody($builder->formatPhp('Tracy\\Debugger::' . $key . ' = ?;', Nette\DI\Helpers::filterArguments([$value])));
            }
        }
