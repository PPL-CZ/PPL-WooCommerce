...
class Bar
{
    ...
    private function renderHtml(string $type, string $suffix = '') : array
    {
        ...
        return ['bar' => Helpers::fixEncoding(Helpers::capture(function () use($type, $panels) {
    ...
    {
        $css = \array_map('file_get_contents', \array_merge([__DIR__ . '/assets/bar.css', __DIR__ . '/../Toggle/toggle.css', __DIR__ . '/../TableSort/table-sort.css', __DIR__ . '/../Dumper/assets/dumper.css', __DIR__ . '/../BlueScreen/assets/bluescreen.css'], Debugger::$customCssFiles));
        echo "'use strict';\n(function(){\n\tvar el = document.createElement('style');\n\tel.setAttribute('nonce', document.currentScript.getAttribute('nonce') || document.currentScript.nonce);\n\tel.className='tracy-debug';\n\tel.textContent=" . \json_encode(\preg_replace('#\\s+#u', ' ', \implode($css))) . ";\n\tdocument.head.appendChild(el);})\n();\n";
        \array_map('readfile', \array_merge([__DIR__ . '/assets/bar.js', __DIR__ . '/../Toggle/toggle.js', __DIR__ . '/../TableSort/table-sort.js', __DIR__ . '/../Dumper/assets/dumper.js', __DIR__ . '/../BlueScreen/assets/bluescreen.js'], Debugger::$customJsFiles));
    }
}
