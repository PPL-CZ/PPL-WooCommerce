...
use PPLCZCPL\Model\ModelInterface;
...
class ObjectSerializer
{
    ...
    public static function toQueryValue(
        ...
        // since \PPLCZVendor\GuzzleHttp\Psr7\Query::build fails with nested arrays
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\PPLCZCPL\Model\\' . $data->{$discriminator};
    ...
    public static function buildQuery(
        ...
        return \PPLCZVendor\GuzzleHttp\Psr7\Query::build($data, $encoding_type);
    }
}
