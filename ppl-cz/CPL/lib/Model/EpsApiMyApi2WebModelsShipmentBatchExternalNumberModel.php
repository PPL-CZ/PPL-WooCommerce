...
/**
 * EpsApiMyApi2WebModelsShipmentBatchExternalNumberModel
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * EpsApiMyApi2WebModelsShipmentBatchExternalNumberModel Class Doc Comment
 *
 * @category Class
 ...
 */
class EpsApiMyApi2WebModelsShipmentBatchExternalNumberModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Eps.Api.MyApi2.Web.Models.ShipmentBatch.ExternalNumberModel';
    ...
    public function setExternalNumber($external_number)
    {
        if ((mb_strlen($external_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $external_number when calling EpsApiMyApi2WebModelsShipmentBatchExternalNumberModel., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($external_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $external_number when calling EpsApiMyApi2WebModelsShipmentBatchExternalNumberModel., must be bigger than or equal to 1.');
        }
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling EpsApiMyApi2WebModelsShipmentBatchExternalNumberModel., must be bigger than or equal to 1.');
        }
