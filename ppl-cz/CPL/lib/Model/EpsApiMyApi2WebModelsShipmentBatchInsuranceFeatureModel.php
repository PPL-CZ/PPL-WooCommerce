...
/**
 * EpsApiMyApi2WebModelsShipmentBatchInsuranceFeatureModel
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * EpsApiMyApi2WebModelsShipmentBatchInsuranceFeatureModel Class Doc Comment
 *
 * @category Class
 ...
 */
class EpsApiMyApi2WebModelsShipmentBatchInsuranceFeatureModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Eps.Api.MyApi2.Web.Models.ShipmentBatch.InsuranceFeatureModel';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['insurance_price'] === null) {
            $invalidProperties[] = "'insurance_price' can't be null";
        }
        if (($this->container['insurance_price'] < 0)) {
            $invalidProperties[] = "invalid value for 'insurance_price', must be bigger than or equal to 0.";
        }

        if ($this->container['insurance_currency'] === null) {
            $invalidProperties[] = "'insurance_currency' can't be null";
        }
        if ((mb_strlen($this->container['insurance_currency']) < 1)) {
            $invalidProperties[] = "invalid value for 'insurance_currency', the character length must be bigger than or equal to 1.";
        }
     ...
     *
     * @param double $insurance_price Částka připojištění. Max limity - /codelist/servicePriceLimit Délka: 12,4
     *
     * @return self
     */
    public function setInsurancePrice($insurance_price)
    {
        ...
        if (($insurance_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $insurance_price when calling EpsApiMyApi2WebModelsShipmentBatchInsuranceFeatureModel., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string $insurance_currency Připojištění může být pouze v rámci naší národní měny – CZK Délka: 3
     *
     * @return self
     */
    public function setInsuranceCurrency($insurance_currency)
    {
        ...
        if ((mb_strlen($insurance_currency) < 1)) {
            throw new \InvalidArgumentException('invalid length for $insurance_currency when calling EpsApiMyApi2WebModelsShipmentBatchInsuranceFeatureModel., must be bigger than or equal to 1.');
        }
