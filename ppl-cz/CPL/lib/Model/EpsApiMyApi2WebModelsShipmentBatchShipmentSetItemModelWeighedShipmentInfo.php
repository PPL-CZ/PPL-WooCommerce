...
/**
 * EpsApiMyApi2WebModelsShipmentBatchShipmentSetItemModelWeighedShipmentInfo
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * EpsApiMyApi2WebModelsShipmentBatchShipmentSetItemModelWeighedShipmentInfo Class Doc Comment
 *
 * @category Class
 * @package  PPLCZCPL
 * @author   OpenAPI Generator team
 ...
 */
class EpsApiMyApi2WebModelsShipmentBatchShipmentSetItemModelWeighedShipmentInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Eps_Api_MyApi2_Web_Models_ShipmentBatch_ShipmentSetItemModel_weighedShipmentInfo';
     ...
     * Sets weight
     *
     * @param double|null $weight Váha zásilky deklarovaná odesílatelem. Délka: 9,2
     *
     * @return self
     */
    public function setWeight($weight)
    {
        ...
        if (!is_null($weight) && ($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling EpsApiMyApi2WebModelsShipmentBatchShipmentSetItemModelWeighedShipmentInfo., must be bigger than or equal to 0.');
        }
