...
/**
 * EpsApiMyApi2WebModelsShipmentBatchWeighedShipmentFeatureModel
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * EpsApiMyApi2WebModelsShipmentBatchWeighedShipmentFeatureModel Class Doc Comment
 *
 * @category Class
 ...
 */
class EpsApiMyApi2WebModelsShipmentBatchWeighedShipmentFeatureModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Eps.Api.MyApi2.Web.Models.ShipmentBatch.WeighedShipmentFeatureModel';
    ...
    public function setWeight($weight)
    {
        ...
        if (!is_null($weight) && ($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling EpsApiMyApi2WebModelsShipmentBatchWeighedShipmentFeatureModel., must be bigger than or equal to 0.');
        }
