...
/**
 * EpsApiMyApi2WebModelsOrderBatchCreateOrderBatchModel Class Doc Comment
 *
 * @category Class
 ...
 */
class EpsApiMyApi2WebModelsOrderBatchCreateOrderBatchModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Eps.Api.MyApi2.Web.Models.OrderBatch.CreateOrderBatchModel';
    ...
    protected static $openAPITypes = [
        'orders' => '\PPLCZCPL\Model\EpsApiMyApi2WebModelsOrderBatchOrderModel[]'
    ];
     ...
     * Gets orders
     *
     * @return \PPLCZCPL\Model\EpsApiMyApi2WebModelsOrderBatchOrderModel[]
     */
     ...
     * Sets orders
     *
     * @param \PPLCZCPL\Model\EpsApiMyApi2WebModelsOrderBatchOrderModel[] $orders Objednávky
     *
     * @return self
     */
    public function setOrders($orders)
    {
        ...
        if ((count($orders) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orders when calling EpsApiMyApi2WebModelsOrderBatchCreateOrderBatchModel., number of items must be greater than or equal to 1.');
        }
