...
/**
 * EpsApiMyApi2WebModelsShipmentBatchDormantWeighedShipmentFeatureModel
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * EpsApiMyApi2WebModelsShipmentBatchDormantWeighedShipmentFeatureModel Class Doc Comment
 *
 * @category Class
 ...
 */
class EpsApiMyApi2WebModelsShipmentBatchDormantWeighedShipmentFeatureModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Eps.Api.MyApi2.Web.Models.ShipmentBatch.DormantWeighedShipmentFeatureModel';
    ...
    public function setWeight($weight)
    {
        ...
        if (!is_null($weight) && ($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling EpsApiMyApi2WebModelsShipmentBatchDormantWeighedShipmentFeatureModel., must be bigger than or equal to 0.');
        }
