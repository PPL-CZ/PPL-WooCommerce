...
/**
 * EpsApiMyApi2WebModelsShipmentBatchReturnChannelModel Class Doc Comment
 *
 * @category Class
 ...
 */
class EpsApiMyApi2WebModelsShipmentBatchReturnChannelModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Eps.Api.MyApi2.Web.Models.ShipmentBatch.ReturnChannelModel';
    ...
    public function setAddress($address)
    {
        if (!is_null($address) && (mb_strlen($address) > 100)) {
            throw new \InvalidArgumentException('invalid length for $address when calling EpsApiMyApi2WebModelsShipmentBatchReturnChannelModel., must be smaller than or equal to 100.');
        }
