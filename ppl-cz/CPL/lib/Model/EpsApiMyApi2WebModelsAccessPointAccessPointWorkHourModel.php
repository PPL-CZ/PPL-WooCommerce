...
/**
 * EpsApiMyApi2WebModelsAccessPointAccessPointWorkHourModel
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * EpsApiMyApi2WebModelsAccessPointAccessPointWorkHourModel Class Doc Comment
 *
 * @category Class
 ...
 */
class EpsApiMyApi2WebModelsAccessPointAccessPointWorkHourModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Eps.Api.MyApi2.Web.Models.AccessPoint.AccessPointWorkHourModel';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['open_from'] = $data['open_from'] ?? null;
        $this->container['open_to'] = $data['open_to'] ?? null;
    }
     ...
     * Sets week_day
     *
     * @param int|null $week_day Access point work hour week day (1 - Sunday, 7 - Saturday)
     *
     * @return self
     */
    ...
    {
        return $this->container['day_part'];
    }

    /**
     * Sets day_part
     *
     * @param int|null $day_part Access point work hour day part (0 - morning, 1 - afternoon)
     *
     * @return self
     */
    public function setDayPart($day_part)
    {
        $this->container['day_part'] = $day_part;
    ...
    {
        return $this->container['open_from'];
    }

    /**
     * Sets open_from
     *
     * @param string|null $open_from Access point work hour open from
     *
     * @return self
     */
    public function setOpenFrom($open_from)
    {
        $this->container['open_from'] = $open_from;
    ...
    {
        return $this->container['open_to'];
    }

    /**
     * Sets open_to
     *
     * @param string|null $open_to Access point work hour open to
     *
     * @return self
     */
    public function setOpenTo($open_to)
    {
        $this->container['open_to'] = $open_to;
