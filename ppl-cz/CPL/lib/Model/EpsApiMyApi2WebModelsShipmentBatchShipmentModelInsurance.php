...
/**
 * EpsApiMyApi2WebModelsShipmentBatchShipmentModelInsurance Class Doc Comment
 *
 * @category Class
 * @package  PPLCZCPL
 * @author   OpenAPI Generator team
 ...
 */
class EpsApiMyApi2WebModelsShipmentBatchShipmentModelInsurance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Eps_Api_MyApi2_Web_Models_ShipmentBatch_ShipmentModel_insurance';
    ...
    public function setInsurancePrice($insurance_price)
    {
        ...
        if (($insurance_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $insurance_price when calling EpsApiMyApi2WebModelsShipmentBatchShipmentModelInsurance., must be bigger than or equal to 0.');
        }
    ...
    public function setInsuranceCurrency($insurance_currency)
    {
        ...
        if ((mb_strlen($insurance_currency) < 1)) {
            throw new \InvalidArgumentException('invalid length for $insurance_currency when calling EpsApiMyApi2WebModelsShipmentBatchShipmentModelInsurance., must be bigger than or equal to 1.');
        }
