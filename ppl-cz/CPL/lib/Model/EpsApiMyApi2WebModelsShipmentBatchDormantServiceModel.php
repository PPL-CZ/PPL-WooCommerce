...
/**
 * EpsApiMyApi2WebModelsShipmentBatchDormantServiceModel
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * EpsApiMyApi2WebModelsShipmentBatchDormantServiceModel Class Doc Comment
 *
 * @category Class
 ...
 */
class EpsApiMyApi2WebModelsShipmentBatchDormantServiceModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Eps.Api.MyApi2.Web.Models.ShipmentBatch.DormantServiceModel';
     ...
     * Sets code
     *
     * @param string $code Kód služby - /codelist/service Délka: 4
     *
     * @return self
     */
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling EpsApiMyApi2WebModelsShipmentBatchDormantServiceModel., must be bigger than or equal to 1.');
        }
