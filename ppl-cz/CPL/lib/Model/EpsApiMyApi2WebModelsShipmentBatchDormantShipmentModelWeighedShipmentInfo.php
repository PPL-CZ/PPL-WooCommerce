...
/**
 * EpsApiMyApi2WebModelsShipmentBatchDormantShipmentModelWeighedShipmentInfo Class Doc Comment
 *
 * @category Class
 * @package  PPLCZCPL
 * @author   OpenAPI Generator team
 ...
 */
class EpsApiMyApi2WebModelsShipmentBatchDormantShipmentModelWeighedShipmentInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Eps_Api_MyApi2_Web_Models_ShipmentBatch_DormantShipmentModel_weighedShipmentInfo';
    ...
    public function setWeight($weight)
    {
        ...
        if (!is_null($weight) && ($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling EpsApiMyApi2WebModelsShipmentBatchDormantShipmentModelWeighedShipmentInfo., must be bigger than or equal to 0.');
        }
