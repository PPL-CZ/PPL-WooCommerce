...
/**
 * EpsApiMyApi2WebModelsShipmentBatchDormantExternalNumberModel
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * EpsApiMyApi2WebModelsShipmentBatchDormantExternalNumberModel Class Doc Comment
 *
 * @category Class
 ...
 */
class EpsApiMyApi2WebModelsShipmentBatchDormantExternalNumberModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Eps.Api.MyApi2.Web.Models.ShipmentBatch.DormantExternalNumberModel';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['external_number']) > 100)) {
            $invalidProperties[] = "invalid value for 'external_number', the character length must be smaller than or equal to 100.";
        }

        if ((mb_strlen($this->container['external_number']) < 1)) {
            $invalidProperties[] = "invalid value for 'external_number', the character length must be bigger than or equal to 1.";
        }
     ...
     *
     * @param string $external_number Externí číslo zásilky Délka: 50
     *
     * @return self
     */
    public function setExternalNumber($external_number)
    {
        if ((mb_strlen($external_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $external_number when calling EpsApiMyApi2WebModelsShipmentBatchDormantExternalNumberModel., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($external_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $external_number when calling EpsApiMyApi2WebModelsShipmentBatchDormantExternalNumberModel., must be bigger than or equal to 1.');
        }
     ...
     * Sets code
     *
     * @param string $code Kód typu externího čísla podle číselníku codelist/externalNumber Délka: 4
     *
     * @return self
     */
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling EpsApiMyApi2WebModelsShipmentBatchDormantExternalNumberModel., must be bigger than or equal to 1.');
        }
