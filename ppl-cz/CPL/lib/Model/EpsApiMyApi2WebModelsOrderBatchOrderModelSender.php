...
/**
 * EpsApiMyApi2WebModelsOrderBatchOrderModelSender
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * EpsApiMyApi2WebModelsOrderBatchOrderModelSender Class Doc Comment
 *
 * @category Class
 * @package  PPLCZCPL
 * @author   OpenAPI Generator team
 ...
 */
class EpsApiMyApi2WebModelsOrderBatchOrderModelSender implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Eps_Api_MyApi2_Web_Models_OrderBatch_OrderModel_sender';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 250)) {
            throw new \InvalidArgumentException('invalid length for $name when calling EpsApiMyApi2WebModelsOrderBatchOrderModelSender., must be smaller than or equal to 250.');
        }
    ...
    public function setName2($name2)
    {
        if (!is_null($name2) && (mb_strlen($name2) > 250)) {
            throw new \InvalidArgumentException('invalid length for $name2 when calling EpsApiMyApi2WebModelsOrderBatchOrderModelSender., must be smaller than or equal to 250.');
        }
    ...
    public function setStreet($street)
    {
        if (!is_null($street) && (mb_strlen($street) > 60)) {
            throw new \InvalidArgumentException('invalid length for $street when calling EpsApiMyApi2WebModelsOrderBatchOrderModelSender., must be smaller than or equal to 60.');
        }
    ...
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 50)) {
            throw new \InvalidArgumentException('invalid length for $city when calling EpsApiMyApi2WebModelsOrderBatchOrderModelSender., must be smaller than or equal to 50.');
        }
    ...
    public function setZipCode($zip_code)
    {
        if ((mb_strlen($zip_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $zip_code when calling EpsApiMyApi2WebModelsOrderBatchOrderModelSender., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($zip_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $zip_code when calling EpsApiMyApi2WebModelsOrderBatchOrderModelSender., must be bigger than or equal to 1.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if ((mb_strlen($country) < 1)) {
            throw new \InvalidArgumentException('invalid length for $country when calling EpsApiMyApi2WebModelsOrderBatchOrderModelSender., must be bigger than or equal to 1.');
        }
    ...
    public function setContact($contact)
    {
        if (!is_null($contact) && (mb_strlen($contact) > 50)) {
            throw new \InvalidArgumentException('invalid length for $contact when calling EpsApiMyApi2WebModelsOrderBatchOrderModelSender., must be smaller than or equal to 50.');
        }
    ...
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 30)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling EpsApiMyApi2WebModelsOrderBatchOrderModelSender., must be smaller than or equal to 30.');
        }
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 100)) {
            throw new \InvalidArgumentException('invalid length for $email when calling EpsApiMyApi2WebModelsOrderBatchOrderModelSender., must be smaller than or equal to 100.');
        }
