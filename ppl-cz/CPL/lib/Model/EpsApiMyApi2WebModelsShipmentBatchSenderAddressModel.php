...
/**
 * EpsApiMyApi2WebModelsShipmentBatchSenderAddressModel
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * EpsApiMyApi2WebModelsShipmentBatchSenderAddressModel Class Doc Comment
 *
 * @category Class
 ...
 */
class EpsApiMyApi2WebModelsShipmentBatchSenderAddressModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Eps.Api.MyApi2.Web.Models.ShipmentBatch.SenderAddressModel';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling EpsApiMyApi2WebModelsShipmentBatchSenderAddressModel., must be smaller than or equal to 50.');
        }
    ...
    public function setName2($name2)
    {
        if (!is_null($name2) && (mb_strlen($name2) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name2 when calling EpsApiMyApi2WebModelsShipmentBatchSenderAddressModel., must be smaller than or equal to 50.');
        }
    ...
    public function setStreet($street)
    {
        if (!is_null($street) && (mb_strlen($street) > 60)) {
            throw new \InvalidArgumentException('invalid length for $street when calling EpsApiMyApi2WebModelsShipmentBatchSenderAddressModel., must be smaller than or equal to 60.');
        }
    ...
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 50)) {
            throw new \InvalidArgumentException('invalid length for $city when calling EpsApiMyApi2WebModelsShipmentBatchSenderAddressModel., must be smaller than or equal to 50.');
        }
    ...
    public function setZipCode($zip_code)
    {
        if ((mb_strlen($zip_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $zip_code when calling EpsApiMyApi2WebModelsShipmentBatchSenderAddressModel., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($zip_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $zip_code when calling EpsApiMyApi2WebModelsShipmentBatchSenderAddressModel., must be bigger than or equal to 1.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if ((mb_strlen($country) < 1)) {
            throw new \InvalidArgumentException('invalid length for $country when calling EpsApiMyApi2WebModelsShipmentBatchSenderAddressModel., must be bigger than or equal to 1.');
        }
    ...
    public function setContact($contact)
    {
        if (!is_null($contact) && (mb_strlen($contact) > 50)) {
            throw new \InvalidArgumentException('invalid length for $contact when calling EpsApiMyApi2WebModelsShipmentBatchSenderAddressModel., must be smaller than or equal to 50.');
        }
    ...
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 30)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling EpsApiMyApi2WebModelsShipmentBatchSenderAddressModel., must be smaller than or equal to 30.');
        }
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 50)) {
            throw new \InvalidArgumentException('invalid length for $email when calling EpsApiMyApi2WebModelsShipmentBatchSenderAddressModel., must be smaller than or equal to 50.');
        }
