...
/**
 * EpsApiMyApi2WebModelsOrderBatchOrderResultItemModel
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * EpsApiMyApi2WebModelsOrderBatchOrderResultItemModel Class Doc Comment
 *
 * @category Class
 ...
 */
class EpsApiMyApi2WebModelsOrderBatchOrderResultItemModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Eps.Api.MyApi2.Web.Models.OrderBatch.OrderResultItemModel';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['import_state'] === null) {
            $invalidProperties[] = "'import_state' can't be null";
        }
    ...
    public function setReferenceId($reference_id)
    {
        if ((mb_strlen($reference_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $reference_id when calling EpsApiMyApi2WebModelsOrderBatchOrderResultItemModel., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($reference_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $reference_id when calling EpsApiMyApi2WebModelsOrderBatchOrderResultItemModel., must be bigger than or equal to 1.');
        }
     ...
     * Gets import_state
     *
     * @return \PPLCZCPL\Model\EpsApiMyApi2BusinessEnumsConstImportState
     */
     ...
     * Sets import_state
     *
     * @param \PPLCZCPL\Model\EpsApiMyApi2BusinessEnumsConstImportState $import_state import_state
     *
     * @return self
     */
