...
/**
 * AddressWhisperApi Class Doc Comment
 *
 * @category Class
 * @package  PPLCZCPL
 * @author   OpenAPI Generator team
...
class AddressWhisperApi
{
     ...
     * @param  EpsApiMyApi2WebModelsAddressWhisperCalledFrom $called_from Whispering from street / zip code / city text box (optional)
     ...
     * @return \PPLCZCPL\Model\EpsApiMyApi2WebModelsAddressWhisperAddressWhispModel[]|\PPLCZCPL\Model\EpsApiInfrastructureWebApiModelProblemJsonModel|\PPLCZCPL\Model\EpsApiInfrastructureWebApiModelProblemJsonModel|\PPLCZCPL\Model\EpsApiInfrastructureWebApiModelProblemJsonModel|\PPLCZCPL\Model\EpsApiInfrastructureWebApiModelProblemJsonModel
     */
    public function addressWhisperGet($street = null, $zip_code = null, $city = null, $called_from = null, $accept_language = null, $x_correlation_id = null, $x_log_level = null)
    {
        list($response) = $this->addressWhisperGetWithHttpInfo($street, $zip_code, $city, $called_from, $accept_language, $x_correlation_id, $x_log_level);
        return $response;
    }

    /**
     * Operation addressWhisperGetWithHttpInfo
     *
     * Našeptávač adres
     *
     * @param  string $street Street (optional)
     ...
     */
    public function addressWhisperGetWithHttpInfo($street = null, $zip_code = null, $city = null, $called_from = null, $accept_language = null, $x_correlation_id = null, $x_log_level = null)
    {
        $request = $this->addressWhisperGetRequest($street, $zip_code, $city, $called_from, $accept_language, $x_correlation_id, $x_log_level);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\PPLCZCPL\Model\EpsApiMyApi2WebModelsAddressWhisperAddressWhispModel[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\PPLCZCPL\Model\EpsApiMyApi2WebModelsAddressWhisperAddressWhispModel[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializerPpl::deserialize($content, '\PPLCZCPL\Model\EpsApiMyApi2WebModelsAddressWhisperAddressWhispModel[]', []),
            ...
            $returnType = '\PPLCZCPL\Model\EpsApiMyApi2WebModelsAddressWhisperAddressWhispModel[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializerPpl::deserialize(
                        $e->getResponseBody(),
                        '\PPLCZCPL\Model\EpsApiMyApi2WebModelsAddressWhisperAddressWhispModel[]',
    ...
    /**
     * Operation addressWhisperGetAsync
     *
     * Našeptávač adres
     *
     * @param  string $street Street (optional)
     ...
     */
    public function addressWhisperGetAsync($street = null, $zip_code = null, $city = null, $called_from = null, $accept_language = null, $x_correlation_id = null, $x_log_level = null)
    {
        return $this->addressWhisperGetAsyncWithHttpInfo($street, $zip_code, $city, $called_from, $accept_language, $x_correlation_id, $x_log_level)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation addressWhisperGetAsyncWithHttpInfo
     *
     * Našeptávač adres
     *
     * @param  string $street Street (optional)
     ...
     * @return \PPLCZVendor\GuzzleHttp\Promise\PromiseInterface
     */
    public function addressWhisperGetAsyncWithHttpInfo($street = null, $zip_code = null, $city = null, $called_from = null, $accept_language = null, $x_correlation_id = null, $x_log_level = null)
    {
        $returnType = '\PPLCZCPL\Model\EpsApiMyApi2WebModelsAddressWhisperAddressWhispModel[]';
        $request = $this->addressWhisperGetRequest($street, $zip_code, $city, $called_from, $accept_language, $x_correlation_id, $x_log_level);
    ...
    /**
     * Create request for operation 'addressWhisperGet'
     *
     * @param  string $street Street (optional)
     * @param  string $zip_code Zip code (optional)
     * @param  string $city City (optional)
     ...
     */
    public function addressWhisperGetRequest($street = null, $zip_code = null, $city = null, $called_from = null, $accept_language = null, $x_correlation_id = null, $x_log_level = null)
    {

        $resourcePath = '/addressWhisper';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializerPpl::toQueryValue(
            $called_from,
            'CalledFrom', // param base name
            'EpsApiMyApi2WebModelsAddressWhisperCalledFrom', // openApiType
            'form', // style
            true, // explode
            false // required
        ) ?? []);
