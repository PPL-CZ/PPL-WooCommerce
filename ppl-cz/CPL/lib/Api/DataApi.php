...
class DataApi
{
     ...
     * Operation getData
     *
     * Metoda pro stažení štítku.
     *
     * @param  string $data_guid The requested data reference (required)
     ...
     */
    public function getData($data_guid, $accept_language = null, $x_correlation_id = null, $x_log_level = null)
    {
        list($response) = $this->getDataWithHttpInfo($data_guid, $accept_language, $x_correlation_id, $x_log_level);
        return $response;
    }
     ...
     */
    public function getDataWithHttpInfo($data_guid, $accept_language = null, $x_correlation_id = null, $x_log_level = null)
    {
        $request = $this->getDataRequest($data_guid, $accept_language, $x_correlation_id, $x_log_level);
     ...
     */
    public function getDataAsync($data_guid, $accept_language = null, $x_correlation_id = null, $x_log_level = null)
    {
        return $this->getDataAsyncWithHttpInfo($data_guid, $accept_language, $x_correlation_id, $x_log_level)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \PPLCZVendor\GuzzleHttp\Promise\PromiseInterface
     */
    public function getDataAsyncWithHttpInfo($data_guid, $accept_language = null, $x_correlation_id = null, $x_log_level = null)
    {
        $returnType = '\SplFileObject';
        $request = $this->getDataRequest($data_guid, $accept_language, $x_correlation_id, $x_log_level);
     ...
     */
    public function getDataRequest($data_guid, $accept_language = null, $x_correlation_id = null, $x_log_level = null)
    {
        // verify the required parameter 'data_guid' is set
        if ($data_guid === null || (is_array($data_guid) && count($data_guid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $data_guid when calling getData'
            );
        }

        $resourcePath = '/data/{dataGuid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($data_guid !== null) {
            $resourcePath = str_replace(
                '{' . 'dataGuid' . '}',
                ObjectSerializerPpl::toPathValue($data_guid),
                $resourcePath
            );
        }
