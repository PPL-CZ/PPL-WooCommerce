...
/**
 * VersionInformationApi Class Doc Comment
 *
 * @category Class
 * @package  PPLCZCPL
 * @author   OpenAPI Generator team
...
class VersionInformationApi
{
    ...
    /**
     * Operation versionInformationGet
     *
     ...
     * @return \PPLCZCPL\Model\EpsApiMyApi2BusinessDtoVersionInformationVersionInformationDto[]|\PPLCZCPL\Model\EpsApiInfrastructureWebApiModelProblemJsonModel|\PPLCZCPL\Model\EpsApiInfrastructureWebApiModelProblemJsonModel|\PPLCZCPL\Model\EpsApiInfrastructureWebApiModelProblemJsonModel
     */
    public function versionInformationGet($limit, $offset, $accept_language = null, $x_correlation_id = null, $x_log_level = null)
    {
        list($response) = $this->versionInformationGetWithHttpInfo($limit, $offset, $accept_language, $x_correlation_id, $x_log_level);
        return $response;
    }

    /**
     * Operation versionInformationGetWithHttpInfo
     *
     * Metoda slouží k získávání novinek, informací, plánované odstávky a další důležité informace vztahující se k (nejen) CPL.
     *
     ...
     */
    public function versionInformationGetWithHttpInfo($limit, $offset, $accept_language = null, $x_correlation_id = null, $x_log_level = null)
    {
        $request = $this->versionInformationGetRequest($limit, $offset, $accept_language, $x_correlation_id, $x_log_level);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\PPLCZCPL\Model\EpsApiMyApi2BusinessDtoVersionInformationVersionInformationDto[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\PPLCZCPL\Model\EpsApiMyApi2BusinessDtoVersionInformationVersionInformationDto[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializerPpl::deserialize($content, '\PPLCZCPL\Model\EpsApiMyApi2BusinessDtoVersionInformationVersionInformationDto[]', []),
            ...
            $returnType = '\PPLCZCPL\Model\EpsApiMyApi2BusinessDtoVersionInformationVersionInformationDto[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializerPpl::deserialize(
                        $e->getResponseBody(),
                        '\PPLCZCPL\Model\EpsApiMyApi2BusinessDtoVersionInformationVersionInformationDto[]',
    ...
    /**
     * Operation versionInformationGetAsync
     *
     * Metoda slouží k získávání novinek, informací, plánované odstávky a další důležité informace vztahující se k (nejen) CPL.
     *
     * @param  int $limit (required)
     ...
     */
    public function versionInformationGetAsync($limit, $offset, $accept_language = null, $x_correlation_id = null, $x_log_level = null)
    {
        return $this->versionInformationGetAsyncWithHttpInfo($limit, $offset, $accept_language, $x_correlation_id, $x_log_level)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation versionInformationGetAsyncWithHttpInfo
     *
     * Metoda slouží k získávání novinek, informací, plánované odstávky a další důležité informace vztahující se k (nejen) CPL.
     *
     * @param  int $limit (required)
     ...
     * @return \PPLCZVendor\GuzzleHttp\Promise\PromiseInterface
     */
    public function versionInformationGetAsyncWithHttpInfo($limit, $offset, $accept_language = null, $x_correlation_id = null, $x_log_level = null)
    {
        $returnType = '\PPLCZCPL\Model\EpsApiMyApi2BusinessDtoVersionInformationVersionInformationDto[]';
        $request = $this->versionInformationGetRequest($limit, $offset, $accept_language, $x_correlation_id, $x_log_level);
    ...
    /**
     * Create request for operation 'versionInformationGet'
     *
     * @param  int $limit (required)
     * @param  int $offset (required)
     * @param  string $accept_language Language specification, default language: cs-CZ (optional)
     ...
     */
    public function versionInformationGetRequest($limit, $offset, $accept_language = null, $x_correlation_id = null, $x_log_level = null)
    {
        // verify the required parameter 'limit' is set
        if ($limit === null || (is_array($limit) && count($limit) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $limit when calling versionInformationGet'
            );
        }
        if ($limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling VersionInformationApi.versionInformationGet, must be smaller than or equal to 1000.');
        }
        if ($limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling VersionInformationApi.versionInformationGet, must be bigger than or equal to 1.');
        }

        // verify the required parameter 'offset' is set
        if ($offset === null || (is_array($offset) && count($offset) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $offset when calling versionInformationGet'
            );
        }
        if ($offset > 2147483647) {
            throw new \InvalidArgumentException('invalid value for "$offset" when calling VersionInformationApi.versionInformationGet, must be smaller than or equal to 2147483647.');
        }
        if ($offset < 0) {
            throw new \InvalidArgumentException('invalid value for "$offset" when calling VersionInformationApi.versionInformationGet, must be bigger than or equal to 0.');
        }


        $resourcePath = '/versionInformation';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
