...
class InfoApi
{
     ...
     * @return \PPLCZCPL\Model\EpsApiInfrastructureWebApiModelInfoModel|\PPLCZCPL\Model\EpsApiInfrastructureWebApiModelProblemJsonModel|\PPLCZCPL\Model\EpsApiInfrastructureWebApiModelProblemJsonModel
     */
    public function infoGet($accept_language = null, $x_correlation_id = null, $x_log_level = null)
    {
        list($response) = $this->infoGetWithHttpInfo($accept_language, $x_correlation_id, $x_log_level);
        return $response;
    }
     ...
     * @throws \PPLCZCPL\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \PPLCZCPL\Model\EpsApiInfrastructureWebApiModelInfoModel|\PPLCZCPL\Model\EpsApiInfrastructureWebApiModelProblemJsonModel|\PPLCZCPL\Model\EpsApiInfrastructureWebApiModelProblemJsonModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function infoGetWithHttpInfo($accept_language = null, $x_correlation_id = null, $x_log_level = null)
    {
        $request = $this->infoGetRequest($accept_language, $x_correlation_id, $x_log_level);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\PPLCZCPL\Model\EpsApiInfrastructureWebApiModelInfoModel' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\PPLCZCPL\Model\EpsApiInfrastructureWebApiModelInfoModel' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializerPpl::deserialize($content, '\PPLCZCPL\Model\EpsApiInfrastructureWebApiModelInfoModel', []),
            ...
            $returnType = '\PPLCZCPL\Model\EpsApiInfrastructureWebApiModelInfoModel';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializerPpl::deserialize(
                        $e->getResponseBody(),
                        '\PPLCZCPL\Model\EpsApiInfrastructureWebApiModelInfoModel',
     ...
     */
    public function infoGetAsync($accept_language = null, $x_correlation_id = null, $x_log_level = null)
    {
        return $this->infoGetAsyncWithHttpInfo($accept_language, $x_correlation_id, $x_log_level)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \PPLCZVendor\GuzzleHttp\Promise\PromiseInterface
     */
    public function infoGetAsyncWithHttpInfo($accept_language = null, $x_correlation_id = null, $x_log_level = null)
    {
        $returnType = '\PPLCZCPL\Model\EpsApiInfrastructureWebApiModelInfoModel';
        $request = $this->infoGetRequest($accept_language, $x_correlation_id, $x_log_level);
     ...
     */
    public function infoGetRequest($accept_language = null, $x_correlation_id = null, $x_log_level = null)
    {
